               ...
               <ul className='my-1'>
                  ...
                  <li className='flex px-2'>
                     ...
                     <div className='grow flex items-center border-b border-slate-100 dark:border-slate-700 text-sm py-2'>
                        <div className='grow flex justify-between'>
                           <div className='self-center'>Approved request by Teslia for 20 credits</div>
                     ...
                     <div className='grow flex items-center border-b border-slate-100 dark:border-slate-700 text-sm py-2'>
                        <div className='grow flex justify-between'>
                           <div className='self-center'>
                              <div className='self-center'>Approved request by Googlia for 30 credits</div>
                           </div>
                           <div className='shrink-0 self-end ml-2'>
                              <a className='font-medium text-indigo-500 hover:text-indigo-600 dark:hover:text-indigo-400' href='#0'>
                                 View<span className='hidden sm:inline'> -&gt;</span>
                  ...
                  <li className='flex px-2'>
                     ...
                     <div className='grow flex items-center text-sm py-2'>
                        <div className='grow flex justify-between'>
                           <div className='self-center'>
                              <div className='self-center'>Rejected request by Zephra for 73 credits</div>
                           </div>
                           <div className='shrink-0 self-end ml-2'>
                              <a className='font-medium text-indigo-500 hover:text-indigo-600 dark:hover:text-indigo-400' href='#0'>
                                 View<span className='hidden sm:inline'> -&gt;</span>
               ...
               <ul className='my-1'>
                  ...
                  <li className='flex px-2'>
                     ...
                     <div className='grow flex items-center border-b border-slate-100 dark:border-slate-700 text-sm py-2'>
                        <div className='grow flex justify-between'>
                           <div className='self-center'>
                              <div className='self-center'>Approved request by Metica for 70 credits</div>
                           </div>
                           <div className='shrink-0 self-end ml-2'>
                              <a className='font-medium text-indigo-500 hover:text-indigo-600 dark:hover:text-indigo-400' href='#0'>
                                 View<span className='hidden sm:inline'> -&gt;</span>
                  ...
                  <li className='flex px-2'>
                     ...
                     <div className='grow flex items-center text-sm py-2'>
                        <div className='grow flex justify-between'>
                           <div className='self-center'>
                              <div className='self-center'>Rejected request by Geologica for 130 credits</div>
                           </div>
                           <div className='shrink-0 self-end ml-2'>
                              <a className='font-medium text-indigo-500 hover:text-indigo-600 dark:hover:text-indigo-400' href='#0'>
                                 View<span className='hidden sm:inline'> -&gt;</span>
